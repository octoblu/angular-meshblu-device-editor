{_, angular, OctobluDeviceSchemaTransmogrifier} = window

class SchemaTransmogrifyController
  constructor: (@scope) ->
    constructor: (@scope) ->
...
window
  ...
  .controller 'SchemaTransmogrifyController', ['$scope', SchemaTransmogrifyController]
